...
QT_MOC_LITERAL(1, 16, 8), // "upCancel"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 10), // "downCancel"
QT_MOC_LITERAL(4, 37, 10), // "setMyFloor"
QT_MOC_LITERAL(5, 48, 2), // "up"
QT_MOC_LITERAL(6, 51, 4) // "down"

    },
    "ThreadOperation\0upCancel\0\0downCancel\0"
    "setMyFloor\0up\0down"
};
...
void ThreadOperation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->upCancel(); break;
        case 1: _t->downCancel(); break;
        case 2: _t->setMyFloor((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->up(); break;
        ...
        {
            using _t = void (ThreadOperation::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ThreadOperation::upCancel)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ThreadOperation::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ThreadOperation::downCancel)) {
                *result = 1;
                return;
            }
        }
